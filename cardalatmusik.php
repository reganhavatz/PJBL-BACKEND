...
<head>
    ...
    <title>Alat Musik Tradisional - Culturenesia</title>
</head>
...
<body>
    ...
    <div class="penjelasan">
        <?php
        $query_bg = mysqli_query($conn, "SELECT * FROM tb_konten WHERE id = 27");
    ...
    <div class="container-utama">
        <div class="grid-cards">
            <?php
            $query = "SELECT * FROM tb_konten WHERE kategori = 'Alat musik tradisional'";
