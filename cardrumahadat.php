...
<head>
    ...
    <title>Rumah Adat - Culturenesia</title>
</head>
...
<body>
    ...
    <div class="banner-full">
        <?php
        $sql_banner = mysqli_query($conn, "SELECT * FROM tb_konten WHERE id = 14");
    ...
    <div class="penjelasan">
        <?php
        $query_bg = mysqli_query($conn, "SELECT * FROM tb_konten WHERE id = 25");
    ...
    <div class="container-utama">
        <div class="grid-cards">
            <?php
            $query = "SELECT * FROM tb_konten WHERE kategori = 'Rumah Adat'";
